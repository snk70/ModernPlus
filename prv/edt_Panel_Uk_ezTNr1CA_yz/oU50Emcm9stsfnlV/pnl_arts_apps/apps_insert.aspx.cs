...
public partial class prv_edt_Panel_Uk_ezTNr1CA_yz_oU50Emcm9stsfnlV_pnl_arts_apps_apps_insert : System.Web.UI.Page
{
            ...
            if (Request.Form["mode"] == "edit")
            {
                try
                {
                    ...
                    if (title_txt.Text == "")
                    {
                        ...
                        con2.Open();
                        SqlCommand com2 = new SqlCommand("Select * From [tbl_app] Where(paper_link='" + L_paper + "')", con2);
    ...
    protected void btn_publish_Click(object sender, EventArgs e)
    {
        ...
        if (lbl_mode.Text == "edit")
        {
            ...
            //string url_post = Get_Path_in_Local_OR_Main.get("http://localhost/Modern_Plus/prv/dfgasdfgsdfgsdfgsdfg/yaheidar/asfgasgafdgdfgdsgsdfgsdfgsdfgsdfg/asdfansfjkasjkdfjwefkqwQR/sdfgsdfgsdfg_add_app.php", host_address + "/prv/dfgasdfgsdfgsdfgsdfg/yaheidar/asfgasgafdgdfgdsgsdfgsdfgsdfgsdfg/asdfansfjkasjkdfjwefkqwQR/sdfgsdfgsdfg_add_app.php");
            ...
            //if (wm.GetResponse() == "o")
            {
                ...
                post_get_information.MyWebRequest wm = new post_get_information.MyWebRequest(Request.Url.ToString().Replace(Request.RawUrl.ToString(), "/Master_Pages/post_show.aspx?type=app&link=" + paper_link.Text));
                ...
                //if (wm2.GetResponse() == "o")
                {
                    ...
                    tb.UpdateQuery(title_txt.Text, name_txt.Text, type_txt.Text, txt_prc.Text, CKEditorControl1.Text, dt, tm, "", Request.Url.ToString().Replace(Request.RawUrl, "/") + Edit_Content_class.Posts_link_Path + "/" + paper_link.Text, meta_key.Text, meta_desc.Text, paper_cmt.Text, paper_link.Text, up_img, 0, int.Parse(lbl_row.Text));
                    Session.RemoveAll();
                    //Session[Request.UserHostAddress] = Request.UserAgent.GetHashCode() + DateTime.Now.Hour.GetHashCode().ToString();
                    Response.Redirect("~/prv/edt_Panel_Uk_ezTNr1CA_yz/oU50Emcm9stsfnlV/pnl_arts_apps/apps_mng.aspx");
                }
                //else
                //{
