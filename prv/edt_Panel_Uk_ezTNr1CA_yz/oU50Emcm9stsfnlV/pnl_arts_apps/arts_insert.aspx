<%@ Page Language="C#" AutoEventWireup="true" CodeFile="arts_insert.aspx.cs" Inherits="prv_edt_Panel_Uk_ezTNr1CA_yz_oU50Emcm9stsfnlV_pnl_arts_apps_arts_mng" %>
...
<head id="Head1" runat="server">
    <title id="Title1" runat="server">مطالب</title>
    <style type="text/css">
        #form1
        {
            direction: ltr;
...
<body>
    ...
    <br />
    <br />
    <asp:Button ID="add_pic" runat="server" Height="32px" Text="افزوردن"
        Width="105px" onclick="add_pic_Click" />
