...
public partial class Contact_Comment_Default : System.Web.UI.Page
{
    string host_address = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (Query_Result == "1")
            {
                dv1.InnerHtml = "<br /><br /><br /><br /><br /><br /><br /><br /><br /><center><p class=\"pt1\">با تشکر از شما ؛ نظر شما ثبت شد و در اسرع وقت به آن رسیدگی میشود .</p><p class=\"pt1\">برای انتقال به صفحه اصلی <a class=\"pt1\" href=\"http://www.modernplus.ir\"> اینجا کلیک کنید</a> .</p></center>";
